...
Marvelmind_Thread_ (void* param)
{
    ...
    while (hedge->terminationRequired==false)
    {
        ...
        {
            if (hedge->verbose) puts("Read error");
...
//////////////////////////////////////////////////////////////////////////////
// Print average position X
//////////////////////////////////////////////////////////////////////////////
int16_t getPositionX (struct MarvelmindHedge * hedge)
{
    struct PositionValue position;
    getPositionFromMarvelmindHedge (hedge, &position);
    return position.x;
...
//////////////////////////////////////////////////////////////////////////////
// Print average position Y
//////////////////////////////////////////////////////////////////////////////
int16_t getPositionY (struct MarvelmindHedge * hedge)
{
    struct PositionValue position;
    getPositionFromMarvelmindHedge (hedge, &position);
    return position.y;
...
//////////////////////////////////////////////////////////////////////////////
// Print average position Z
//////////////////////////////////////////////////////////////////////////////
int16_t getPositionZ (struct MarvelmindHedge * hedge)
{
    struct PositionValue position;
    getPositionFromMarvelmindHedge (hedge, &position);
    return position.z;
...
//////////////////////////////////////////////////////////////////////////////
// Print average timestamp
//////////////////////////////////////////////////////////////////////////////
uint32_t getTimestamp (struct MarvelmindHedge * hedge)
{
    struct PositionValue position;
    getPositionFromMarvelmindHedge (hedge, &position);
